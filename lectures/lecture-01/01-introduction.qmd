...
- Run and call [language models]{.alert} from your own code
- Collect data from [web APIs]{.alert} and process it [at scale]{.alert}
- Run your own [server in the cloud]{.alert} and package your work with [containers]{.alert}
:::
...
- [Free accounts]{.alert}: [OpenRouter](https://openrouter.ai/) for Lecture 14, [AWS](https://aws.amazon.com/) for Lectures 16 and 17. Both are free
