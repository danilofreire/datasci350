...
[![](figures/venn-orig-1.png){height="520px" style="display: block; margin: auto;"}](#){data-modal-type="image" data-modal-url="figures/venn-orig-1.png"}

[Source: [Drew Conway (2010)](http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram)]{style="font-size: 18px; display: block; text-align: center;"}

## An old classic {transition="none"}

[![](figures/venn-orig-2.png){height="520px" style="display: block; margin: auto;"}](#){data-modal-type="image" data-modal-url="figures/venn-orig-2.png"}

[Source: [Drew Conway (2010)](http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram)]{style="font-size: 18px; display: block; text-align: center;"}

## An old classic {transition="none"}

[![](figures/venn-orig-3.png){height="520px" style="display: block; margin: auto;"}](#){data-modal-type="image" data-modal-url="figures/venn-orig-3.png"}

[Source: [Drew Conway (2010)](http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram)]{style="font-size: 18px; display: block; text-align: center;"}

## An old classic {transition="none"}

[![](figures/venn-orig-4.png){height="520px" style="display: block; margin: auto;"}](#){data-modal-type="image" data-modal-url="figures/venn-orig-4.png"}

[Source: [Drew Conway (2010)](http://drewconway.com/zia/2013/3/26/the-data-science-venn-diagram)]{style="font-size: 18px; display: block; text-align: center;"}

## An old classic {transition="none"}

[![](figures/venn-orig-5.png){height="520px" style="display: block; margin: auto;"}](#){data-modal-type="image" data-modal-url="figures/venn-orig-5.png"}
...
:::{.columns}
:::{.column width="50%"}
- Use the [command line]{.alert} to manage files, directories, and scripts
- Track changes and collaborate on code with [Git and GitHub]{.alert}
- Create [reproducible reports and presentations]{.alert} with Quarto
- Use local and hosted [language models]{.alert} responsibly to help with programming tasks
:::

::: {.column width="50%"}
- Run code on [cloud servers]{.alert} with Amazon Web Services
- Collect data from [web APIs]{.alert} and query it with [SQL in DuckDB]{.alert}
- Speed up data processing with [parallel computing]{.alert}
- Package projects with [virtual environments]{.alert} and [Docker containers]{.alert}
:::
:::
:::
...
- [Ollama](https://ollama.com/) to run language models on your own laptop, and [OpenRouter](https://openrouter.ai/) to call hosted ones from Python
...
- [requests](https://requests.readthedocs.io/) for collecting data from web APIs

:::{style="margin-top: 40px; text-align: center;"}
[![](figures/requests.png){width="28%"}](#){data-modal-type="image" data-modal-url="figures/requests.png"}
:::

## Key tools

- [Amazon Web Services](https://aws.amazon.com/) and [Ubuntu](https://ubuntu.com/) for running your own server in the cloud

:::: {.columns}
::: {.column width="50%"}
:::{style="margin-top: 60px;"}
[![](figures/aws.png){width="70%"}](#){data-modal-type="image" data-modal-url="figures/aws.png"}
:::
:::

::: {.column width="50%"}
:::{style="margin-top: 75px;"}
[![](figures/ubuntu.png){width="85%"}](#){data-modal-type="image" data-modal-url="figures/ubuntu.png"}
:::
:::
::::
...
- [pandas](https://pandas.pydata.org/), [SQLite](https://sqlite.org/), [DuckDB](https://duckdb.org/), and [Dask](https://www.dask.org/) for working with data at scale
...
[![](figures/sqlite.png){width="65%"}](#){data-modal-type="image" data-modal-url="figures/sqlite.png"}
:::
:::
::::
...
- [Syllabus]{.alert}: On the [website](https://danilofreire.github.io/datasci350/syllabus.html) and the [repository](https://github.com/danilofreire/datasci350/blob/main/syllabus/syllabus.pdf)
...
- [Windows]{.alert}: Please install the Windows Subsystem for Linux. Start with [our tutorial](https://danilofreire.github.io/datasci350/06-wsl-tutorial.html), then see the [Microsoft install guide](https://learn.microsoft.com/en-us/windows/wsl/install), [It's FOSS](https://itsfoss.com/install-bash-on-windows/) and the [WSL FAQ](https://learn.microsoft.com/en-us/windows/wsl/faq)
...
- [Python]{.alert}: We use the Anaconda distribution. Download it [here](https://www.anaconda.com/download) and follow [our tutorial](https://danilofreire.github.io/datasci350/01-vscode-anaconda-tutorial.html)
- [Quarto]{.alert}: How we write reports and slides. Download it [here](https://quarto.org/docs/get-started/)
- [Ollama]{.alert}: Runs language models on your own laptop. Download it [here](https://ollama.com/download)
- [uv]{.alert}: A faster package manager, used later for reproducible environments. Instructions [here](https://docs.astral.sh/uv/getting-started/installation/)
- [Docker]{.alert}: Containerisation tool. Download it [here](https://www.docker.com/products/docker-desktop/)
- [Free accounts]{.alert}: [OpenRouter](https://openrouter.ai/) for Lecture 14, [AWS](https://aws.amazon.com/) for Lectures 16 and 17. Both are free, but AWS asks for a payment card
...
- Time for questions about installing the terminal. You will need it next week
