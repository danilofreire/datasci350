...
1. Explain how computers work from the ground up, starting with binary code
2. Get familiar with other key computer encodings like hexadecimal, ASCII, and Unicode
3. Describe the pioneers of computing and the development of Assembly language
...
::: {.column width="50%"}
- The [first mechanical calculator](https://en.wikipedia.org/wiki/Stepped_reckoner) capable of performing all four basic arithmetic operations (addition, subtraction, multiplication, and division)
...
The 1970s put a whole CPU on one silicon chip:
...
- They are [tiny and cheap]{.alert}. A laptop chip holds tens of billions of transistors (up to ~200 billion in the largest GPUs) and performs billions of operations per second!
...
- He built the [Z3](https://en.wikipedia.org/wiki/Z3_(computer)) in 1941, the first working programmable, fully automatic digital computer
- Like his earlier [Z1](https://en.wikipedia.org/wiki/Z1_(computer)) (1938), the Z3 used [binary arithmetic]{.alert} and read its instructions from punched film
- His Z4 (1945) started with 64 words of memory, just 256 bytes
...
- The first assemblers were human! Programmers translated their code to binary by hand
- [Kathleen Booth](https://en.wikipedia.org/wiki/Kathleen_Booth) wrote the first assembly language in 1947
:::
:::
::::
...
::: {.column width="50%"}
:::{style="font-size: 24px;"}
- "Hello, World!" as raw bytes (hex), straight from the ASCII table:
...
- Please have your terminal ready ([WSL](https://learn.microsoft.com/en-us/windows/wsl/install) on Windows), and we will start coding!
